...
Under Plugins > Homebridge Shell Command > Settings, add an accessory and fill in the form!
...
Originally forked from [homebridge-plugin-command](https://github.com/adyanth/homebridge-plugin-command) by [adyanth](https://github.com/adyanth), licensed under Apache-2.0.
